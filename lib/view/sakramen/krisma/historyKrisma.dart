...
class _HistoryKrisma extends State<HistoryKrisma> {
  ...
  Future<List> callDb() async {
    ...
    Message message = Message('Agent Page', 'Agent Pencarian', "REQUEST",
        Tasks('cari pelayanan', [idGereja, "krisma", "history"]));
  ...
  Future updateKegiatan(id, status) async {
    ...
    if (hasilDaftar == "failed") {
      Fluttertoast.showToast(
          ...
          msg: "Gagal Mengaktifkan Kegiatan Krisma",
      ...
      Fluttertoast.showToast(
          /////// Widget toast untuk menampilkan pesan pada halaman
          msg: "Berhasil Mengaktifkan Kegiatan Krisma",
          toastLength: Toast.LENGTH_SHORT,
          gravity: ToastGravity.CENTER,
          timeInSecForIosWeb: 2,
                                      ...
                                      onPressed: () async {
                                        showDialog<String>(
                                          ...
                                          builder: (BuildContext context) =>
                                            ...
                                            content: const Text(
                                                'Yakin ingin mengaktifkan Krisma ini?'),
                                            actions: <Widget>[
                                              TextButton(
