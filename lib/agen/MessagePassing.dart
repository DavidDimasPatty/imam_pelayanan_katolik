...
class MessagePassing {
  ...
  Map<String, Agent> agents = {'Agent Pencarian': AgentPencarian(), 'Agent Pendaftaran': agenPendaftaran(), 'Agent Setting': agenSetting(), 'Agent Akun': agenAkun(), 'Agent Page': agenPage()};
