...
class HistoryKrismaUser extends StatefulWidget {
  ...
  final idGereja;
  final idKrisma;
  HistoryKrismaUser(this.names, this.idUser, this.idGereja, this.idKrisma);
  @override
  _HistoryKrismaUser createState() =>
      _HistoryKrismaUser(this.names, this.idUser, this.idGereja, this.idKrisma);
}

class _HistoryKrismaUser extends State<HistoryKrismaUser> {
  var names;
  var emails;
  var distance;
  List daftarUser = [];
  ...
  Future<List> callDb() async {
    return await MongoDatabase.HistoryUserKrismaTerdaftar(idKrisma);
  }
        ...
        leading: IconButton(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => HistoryKrisma(names, idUser, idGereja)),
            );
          },
