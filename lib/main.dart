...
Future callDb() async {
  ...
  completer.complete(); //Batas pengerjaan yang memerlukan completer //Batas pengerjaan yang memerlukan completer
...
callTampilan(tampilan) {
  ...
  if (tampilan[1][0] == "pagi") {
    ...
    if (tampilan[0][0].length != 0 && tampilan[0][0] != "nothing") {
      ...
      var object2 = tampilan[0][0][1].toString().substring(10, tampilan[0][0][1].length - 2);
      var object1 = tampilan[0][0][0].toString().substring(10, tampilan[0][0][0].length - 2);
